...
\hline
\rowcolor{cobrablue!20}
\textbf{Fase} & \textbf{Duración} & \textbf{Entregables Principales} \\
\hline
\endhead
Fase 1 & 3-4 meses & Aplicación de escritorio completa, base de datos, documentación \\
\hline
Fase 2 & 4-6 meses & Portal web React.js, API REST, integración e-commerce \\
\hline
Fase 3 & 6-8 meses & App React Native multiplataforma, notificaciones, analytics \\
\hline
\end{longtable}
