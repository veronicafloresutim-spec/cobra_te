...
\usepackage{geomet3 de octubre 2025 & 1.5 & Verónica Flores & Actualización de layout con logotipo oficial Logo.png \\
\hline
...
\centering\rule{5cm}{0.4pt} & \centering\rule{5cm}{0.4pt} \\[0.5cm]
\centering Mtra. Patricia Mendoza Crisóstomo & \centering Fecha \\
\centering Supervisora Académica & \\[1cm]
\centering\rule{5cm}{0.4pt} & \centering\rule{5cm}{0.4pt} \\[0.5cm]
\centering Líder del Proyecto & \centering Fecha \\
& \\
\end{tabular}
\end{center}
